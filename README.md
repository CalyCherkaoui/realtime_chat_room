# REALTIME CHAT ROOM | Ruby On rails ActionCable
## About the project
In this project, I built a real time chat room.
### Main features:
...
```
$ git clone git@github.com:CalyCherkaoui/realtime_chat_room.git
$ cd realtime_chat_room
...
- Hat tip to [Gorails](https://www.gorails.com/)
